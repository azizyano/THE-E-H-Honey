        ...
        <img src={logoh} alt="project Logo" />
           ...
           <Typography></Typography>
            ...
            <form className="input-group mb-4" onSubmit={(event) => {
                    ...
                    <Typography>Sell BEE token at any time you want! </Typography>
                  ...
                  <div className="mb-5">
                    ...
                    <span className="float-right text-muted">1 ETH = 100 BEE</span>
                  </div>
                  <Button type="submit" className={ `${classes.gradient}`}>Sell BEE</Button>
                </form> 
                </Toolbar>           
